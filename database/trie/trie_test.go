...
func testMissingNode(t *testing.T, memonly bool) {
	...
	updateString(trie, "abcd", "abcd")
	updateString(trie, "abc", "abc")
	updateString(trie, "ab", "ab")
	updateString(trie, "ab", "cd")
...
func BenchmarkHash(b *testing.B) {
	...
	for i := 0; i < len(accounts); i++ {
		...
		accounts[i], _ = rlputil.EncodeToBytes([]interface{}{nonce, balance, root, code})
	}
	// Insert the account into the trie and hash it
	trie := newEmpty()
	for i := 0; i < len(addresses); i++ {

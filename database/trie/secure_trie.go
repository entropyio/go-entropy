...
func NewSecure(owner common.Hash, root common.Hash, db *TrieDatabase) (*SecureTrie, error) {
	if db == nil {
...
// secure trie.
func (t *SecureTrie) TryUpdateAccount(key []byte, acc *model.StateAccount) error {
	hk := t.hashKey(key)

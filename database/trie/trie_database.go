...
func NewDatabaseWithCache(diskdb database.KeyValueStore, cache int) *TrieDatabase {
...
func (db *TrieDatabase) DiskDB() database.KeyValueReader {
	return db.diskdb
}
...
func (db *TrieDatabase) commit(hash common.Hash, batch database.Batch, uncacher *cleaner) error {

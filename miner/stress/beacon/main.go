...
//	transitionDifficulty = new(big.Int).Mul(big.NewInt(20), config.MinimumDifficulty)
//
...
//	ethBackend *entropy.Entropy
//	lapi       *lescatalyst.ConsensusAPI
//	lesBackend *les.LightEthereum
//}
//
//func newNode(typ nodetype, genesis *blockchain.Genesis, enodes []*enode.Node) *ethNode {
//	var (
//		err        error
//		api        *ethcatalyst.ConsensusAPI
//		lapi       *lescatalyst.ConsensusAPI
...
//}
//
//func (n *ethNode) insertBlockAndSetHead(parent *model.Header, ed beacon.ExecutableDataV1) error {
//	if !eth2model(n.typ) {
//		return errors.New("invalid node type")
//	}
...
//}
//
//func newNodeManager(genesis *blockchain.Genesis) *nodeManager {
//	return &nodeManager{
...
//	sink := make(chan blockchain.ChainHeadEvent, 1024)
...
//
//	genesis.BaseFee = big.NewInt(config.InitialBaseFee)
...
//}
//
//func makeFullNode(genesis *blockchain.Genesis) (*node.Node, *entropy.Entropy, *ethcatalyst.ConsensusAPI, error) {
...
//	}
//	ethBackend, err := entropy.New(stack, econfig)
//	if err != nil {
//		return nil, nil, nil, err
//	}
//	_, err = les.NewLesServer(stack, ethBackend, econfig)
//	if err != nil {
//		log.Critical("Failed to create the LES server", "err", err)
//	}
//	err = stack.Start()
//	return stack, ethBackend, ethcatalyst.NewConsensusAPI(ethBackend), err
//}
//
//func makeLightNode(genesis *blockchain.Genesis) (*node.Node, *les.LightEthereum, *lescatalyst.ConsensusAPI, error) {
//	// Define the basic configurations for the Entropy node
//	datadir, _ := os.MkdirTemp("", "")
//
//	configObj := &node.Config{
...
//		return nil, nil, nil, err
//	}
//	lesBackend, err := les.New(stack, &entropyconfig.Config{
//		Genesis:         genesis,
//		NetworkId:       genesis.Config.ChainID.Uint64(),
...
//}
//
//func eth2model(typ nodetype) bool {

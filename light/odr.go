...
type OdrBackend interface {
	...
	ChtIndexer() *blockchain.ChainIndexer
	BloomTrieIndexer() *blockchain.ChainIndexer
	BloomIndexer() *blockchain.ChainIndexer
...
// header.
func StateTrieID(header *model.Header) *TrieID {
	return &TrieID{

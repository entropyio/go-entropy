...
func GetHeaderByNumber(ctx context.Context, odr OdrBackend, number uint64) (*model.Header, error) {
...
// hash.
func GetBody(ctx context.Context, odr OdrBackend, hash common.Hash, number uint64) (*model.Body, error) {
...
func GetBlock(ctx context.Context, odr OdrBackend, hash common.Hash, number uint64) (*model.Block, error) {
	...
	return model.NewBlockWithHeader(header).WithBody(body.Transactions, body.Uncles), nil
}

// GetBlockReceipts retrieves the receipts generated by the transactions included
// in a block given by its hash.
func GetBlockReceipts(ctx context.Context, odr OdrBackend, hash common.Hash, number uint64) (model.Receipts, error) {
...
func GetBlockLogs(ctx context.Context, odr OdrBackend, hash common.Hash, number uint64) ([][]*model.Log, error) {
...
func GetUntrustedBlockLogs(ctx context.Context, odr OdrBackend, header *model.Header) ([][]*model.Log, error) {
	// Retrieve the potentially incomplete receipts from disk or network
...
func GetTransaction(ctx context.Context, odr OdrBackend, txHash common.Hash) (*model.Transaction, common.Hash, uint64, uint64, error) {
	r := &TxStatusRequest{Hashes: []common.Hash{txHash}}
	if err := odr.RetrieveTxStatus(ctx, r); err != nil || r.Status[0].Status != blockchain.TxStatusIncluded {

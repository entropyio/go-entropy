...
var encTests = []encTest{
	...
	{val: big.NewInt(-1), error: "rlputil: cannot encode negative *big.Int"},
	...
	{val: testEncoder{}, error: "rlputil: game over: unadressable value of type rlputil.testEncoder, EncodeRLP is pointer method"},

...
func TestStreamErrors(t *testing.T) {
	...
	tests := []struct {
		...
		// Non-valid boolean
		{"02", calls{"Bool"}, nil, errors.New("rlputil: invalid boolean value: 2")},
...
func TestDecodeErrors(t *testing.T) {
	...
	expectErr := "rlputil: type chan bool is not RLP-serializable"
...
type invalidTail2 struct {
	A uint
	B string `rlputil:"tail"`
}

type tailRaw struct {
	A    uint
	Tail []RawValue `rlputil:"tail"`
}
...
var decodeTests = []decodeTest{
	...
	{input: "02", ptr: new(bool), error: "rlputil: invalid boolean value: 2"},
	...
	{input: "850505050505", ptr: new(uint32), error: "rlputil: input string too long for uint32"},
	{input: "C0", ptr: new(uint32), error: "rlputil: expected input string or byte for uint32"},
	{input: "00", ptr: new(uint32), error: "rlputil: non-canonical integer (leading zero bytes) for uint32"},
	{input: "8105", ptr: new(uint32), error: "rlputil: non-canonical size information for uint32"},
	{input: "820004", ptr: new(uint32), error: "rlputil: non-canonical integer (leading zero bytes) for uint32"},
	{input: "B8020004", ptr: new(uint32), error: "rlputil: non-canonical size information for uint32"},

	// slices
	{input: "C0", ptr: new([]uint), value: []uint{}},
	{input: "C80102030405060708", ptr: new([]uint), value: []uint{1, 2, 3, 4, 5, 6, 7, 8}},
	{input: "F8020004", ptr: new([]uint), error: "rlputil: non-canonical size information for []uint"},

	// arrays
	{input: "C50102030405", ptr: new([5]uint), value: [5]uint{1, 2, 3, 4, 5}},
	{input: "C0", ptr: new([5]uint), error: "rlputil: input list has too few elements for [5]uint"},
	{input: "C102", ptr: new([5]uint), error: "rlputil: input list has too few elements for [5]uint"},
	{input: "C6010203040506", ptr: new([5]uint), error: "rlputil: input list has too many elements for [5]uint"},
	{input: "F8020004", ptr: new([5]uint), error: "rlputil: non-canonical size information for [5]uint"},

	// zero sized arrays
	{input: "C0", ptr: new([0]uint), value: [0]uint{}},
	{input: "C101", ptr: new([0]uint), error: "rlputil: input list has too many elements for [0]uint"},

	// byte slices
	{input: "01", ptr: new([]byte), value: []byte{1}},
	{input: "80", ptr: new([]byte), value: []byte{}},
	{input: "8D6162636465666768696A6B6C6D", ptr: new([]byte), value: []byte("abcdefghijklm")},
	{input: "C0", ptr: new([]byte), error: "rlputil: expected input string or byte for []uint8"},
	{input: "8105", ptr: new([]byte), error: "rlputil: non-canonical size information for []uint8"},
	...
	// byte array errors
	{input: "02", ptr: new([5]byte), error: "rlputil: input string too short for [5]uint8"},
	{input: "80", ptr: new([5]byte), error: "rlputil: input string too short for [5]uint8"},
	{input: "820000", ptr: new([5]byte), error: "rlputil: input string too short for [5]uint8"},
	{input: "C0", ptr: new([5]byte), error: "rlputil: expected input string or byte for [5]uint8"},
	{input: "C3010203", ptr: new([5]byte), error: "rlputil: expected input string or byte for [5]uint8"},
	{input: "86010203040506", ptr: new([5]byte), error: "rlputil: input string too long for [5]uint8"},
	{input: "8105", ptr: new([1]byte), error: "rlputil: non-canonical size information for [1]uint8"},
	{input: "817F", ptr: new([1]byte), error: "rlputil: non-canonical size information for [1]uint8"},

	// zero sized byte arrays
	{input: "80", ptr: new([0]byte), value: [0]byte{}},
	{input: "01", ptr: new([0]byte), error: "rlputil: input string too long for [0]uint8"},
	{input: "8101", ptr: new([0]byte), error: "rlputil: input string too long for [0]uint8"},

	// strings
	{input: "00", ptr: new(string), value: "\000"},
	{input: "8D6162636465666768696A6B6C6D", ptr: new(string), value: "abcdefghijklm"},
	{input: "C0", ptr: new(string), error: "rlputil: expected input string or byte for string"},

	// big ints
	{input: "01", ptr: new(*big.Int), value: big.NewInt(1)},
	{input: "89FFFFFFFFFFFFFFFFFF", ptr: new(*big.Int), value: veryBigInt},
	{input: "10", ptr: new(big.Int), value: *big.NewInt(16)}, // non-pointer also works
	{input: "C0", ptr: new(*big.Int), error: "rlputil: expected input string or byte for *big.Int"},
	{input: "820001", ptr: new(big.Int), error: "rlputil: non-canonical integer (leading zero bytes) for *big.Int"},
	{input: "8105", ptr: new(big.Int), error: "rlputil: non-canonical size information for *big.Int"},
	...
	// struct errors
	{
		input: "C0",
		ptr:   new(simplestruct),
		error: "rlputil: too few elements for rlputil.simplestruct",
	},
	{
		input: "C105",
		ptr:   new(simplestruct),
	...
	},
	{
		...
		ptr:   new([]*simplestruct),
		error: "rlputil: too few elements for rlputil.simplestruct, decoding into ([]*rlputil.simplestruct)[1]",
	},
	{
		input: "83222222",
		ptr:   new(simplestruct),
		error: "rlputil: expected input list for rlputil.simplestruct",
	},
	{
		input: "C3010101",
		ptr:   new(simplestruct),
		error: "rlputil: input list has too many elements for rlputil.simplestruct",
	},
	{
		input: "C501C3C00000",
		ptr:   new(recstruct),
	...
	{input: "C0", ptr: new(*uint), error: "rlputil: expected input string or byte for uint"},
	{input: "07", ptr: new(*uint), value: uintp(7)},
	{input: "817F", ptr: new(*uint), error: "rlputil: non-canonical size information for uint"},
	...
	{input: "C50183040404", ptr: new(interface{}), value: []interface{}{[]byte{1}, []byte{4, 4, 4}}},
	{
		input: "C3010203",
		ptr:   new([]io.Reader),
		error: "rlputil: type io.Reader is not RLP-serializable",
	},
	...
	// fuzzer crashes
	{
		...
		ptr:   new(interface{}),
		error: "rlputil: element is larger than containing list",
	},
}
...
// does not kick in for element model implementing Decoder.

...
import (
	...
	"github.com/entropyio/go-entropy/common/crypto/ecies"
	"github.com/entropyio/go-entropy/common/crypto/secp256k1"
...
func readProtocolHandshake(rw MsgReader, our *protoHandshake) (*protoHandshake, error) {
	...
	if msg.Size > baseProtocolMaxMsgSize {
		return nil, fmt.Errorf("message too big, %v", our)
	}
	if msg.Code == discMsg {
...
func sealEIP8(msg interface{}, h *encHandshake) ([]byte, error) {
	...
	if err := rlputil.Encode(buf, msg); err != nil {
		return nil, err
	}
...
func readHandshakeMsg(msg plainDecoder, plainSize int, prv *ecdsa.PrivateKey, r io.Reader) ([]byte, error) {
	...
	// Can't use rlputil.DecodeBytes here because it rejects
	// trailing data (forward-compatibility).
	s := rlputil.NewStream(bytes.NewReader(dec), 0)
...
func (rw *rlpxFrameRW) WriteMsg(msg Msg) error {
	ptype, _ := rlputil.EncodeToBytes(msg.Code)
...
func (rw *rlpxFrameRW) ReadMsg() (msg Msg, err error) {
	...
	if err := rlputil.Decode(content, &msg.Code); err != nil {
		return msg, err
	}

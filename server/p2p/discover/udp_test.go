...
func TestUDP_packetErrors(t *testing.T) {
	...
	test.packetIn(errExpired, pingPacket, &ping{From: testRemote, To: testLocalAnnounced, Version: UDPVersion})
...
func TestUDP_successfulPing(t *testing.T) {
	...
	go test.packetIn(nil, pingPacket, &ping{From: testRemote, To: testLocalAnnounced, Version: UDPVersion, Expiration: futureExp})
...
var testPackets = []struct {
	...
	},
	{
		...
		wantPacket: &ping{
			...
			To:         rpcEndpoint{net.ParseIP("::1"), 2222, 3333},
			Expiration: 1136239445,
			Rest:       []rlputil.RawValue{{0x01}, {0x02}},
		},
	},
	{
		...
		wantPacket: &ping{
			...
			Expiration: 1136239445,
			Rest:       []rlputil.RawValue{{0xC5, 0x01, 0x02, 0x03, 0x04, 0x05}},
		},
	},
	{
		...
		wantPacket: &pong{
			...
			Expiration: 1136239445,
			Rest:       []rlputil.RawValue{{0xC6, 0x01, 0x02, 0x03, 0xC2, 0x04, 0x05}, {0x06}},
		},
	},
	{
		...
		wantPacket: &findnode{
			...
			Expiration: 1136239445,
			Rest:       []rlputil.RawValue{{0x82, 0x99, 0x99}, {0x83, 0x99, 0x99, 0x99}},
		},
	},
	{
		...
		wantPacket: &neighbors{
			...
			Expiration: 1136239445,
			Rest:       []rlputil.RawValue{{0x01}, {0x02}, {0x03}},
		},
	},
}

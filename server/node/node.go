...
func (n *Node) openEndpoints() error {
	...
	n.log.Info("Skip peer-to-peer node", "instance", n.server.Name) // FIXME
...
func (n *Node) OpenDatabase(name string, cache, handles int, namespace string, readonly bool) (database.Database, error) {
	n.lock.Lock()
	defer n.lock.Unlock()
	if n.state == closedState {
		return nil, ErrNodeStopped
...
func (n *Node) OpenDatabaseWithFreezer(name string, cache, handles int, freezer, namespace string, readonly bool) (database.Database, error) {
	n.lock.Lock()
	defer n.lock.Unlock()
	if n.state == closedState {
		return nil, ErrNodeStopped

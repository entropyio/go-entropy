...
func (api *adminAPI) StartRPC(host *string, port *int, cors *string, apis *string, vhosts *string) (bool, error) {
	log.Warning("Deprecation warning", "method", "admin.StartRPC", "use-instead", "admin.StartHTTP")
...
func (api *adminAPI) StopRPC() (bool, error) {
	log.Warning("Deprecation warning", "method", "admin.StopRPC", "use-instead", "admin.StopHTTP")
	return api.StopHTTP()
}

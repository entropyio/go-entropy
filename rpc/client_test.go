...
// This test reproduces https://github.com/entropyio/go-entropy/issues/17837 where the
...
// It is the reproducer for https://github.com/entropy/go-entropy/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-entropy-test-ipc-%d-%d", os.Getpid(), rand.Int63())

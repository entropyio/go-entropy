...
func (c *Client) EntropySubscribe(ctx context.Context, channel interface{}, args ...interface{}) (*ClientSubscription, error) {
...
func (c *Client) reconnect(ctx context.Context) error {
	...
	if err != nil {
		log.Debugf(fmt.Sprintf("RPC client reconnect failed: %v", err))
		return err
	}
	select {

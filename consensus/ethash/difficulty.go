...
func CalcDifficultyFrontierU256(time uint64, parent *model.Header) *big.Int {
	/*
		Algorithm
...
func CalcDifficultyHomesteadU256(time uint64, parent *model.Header) *big.Int {
	/*
...
func MakeDifficultyCalculatorU256(bombDelay *big.Int) func(time uint64, parent *model.Header) *big.Int {

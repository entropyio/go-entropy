...
//	delegateTrie := ec.ClaudeContext.DelegateTrie()
//	candidateTrie := ec.ClaudeContext.CandidateTrie()
//	statedb := ec.statedb
//
...
//
//	candidateCount := 0
//	iter := trie.NewIterator(ec.ClaudeContext.CandidateTrie().NodeIterator(nil))
//	for iter.Next() {
//		candidateCount++
...
//		}
//
//		if err := ec.ClaudeContext.KickoutCandidate(validator.address); err != nil {
//			return err
//		}
...
//	iter := trie.NewIterator(ec.ClaudeContext.MintCntTrie().NodeIterator(prevEpochBytes))
...
//		}
//
//		epochTrie, _ := model.NewEpochTrie(common.Hash{}, ec.ClaudeContext.DB())
//		ec.ClaudeContext.SetEpoch(epochTrie)
//		ec.ClaudeContext.SetValidators(sortedValidators)

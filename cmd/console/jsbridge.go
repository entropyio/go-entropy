...
func (b *bridge) NewAccount(call otto.FunctionCall) (response otto.Value) {
	...
	ret, err := call.Otto.Call("jEntropy.newAccount", nil, password)
	if err != nil {
		throwJSException(err.Error())
	}
	return ret
...
func (b *bridge) OpenWallet(call otto.FunctionCall) (response otto.Value) {
	...
	val, err := call.Otto.Call("jEntropy.openWallet", nil, wallet, passwd)
	if err == nil {
		return val
	}
...
// original RPC method (saved in jEntropy.unlockAccount) with it to actually execute
// the RPC call.
func (b *bridge) UnlockAccount(call otto.FunctionCall) (response otto.Value) {
	...
	val, err := call.Otto.Call("jEntropy.unlockAccount", nil, account, passwd, duration)
	if err != nil {
		throwJSException(err.Error())
	}
	return val
...
func (b *bridge) Sign(call otto.FunctionCall) (response otto.Value) {
	...
	// Send the request to the backend and return
	val, err := call.Otto.Call("jEntropy.sign", nil, message, account, passwd)
	if err != nil {
		throwJSException(err.Error())
	}
	return val
...
func (b *bridge) Send(call otto.FunctionCall) (response otto.Value) {
	...
	//log.Debugf("JS send argument: %s", reqVal)
...
func throwJSException(msg interface{}) otto.Value {
	...
	if err != nil {
		log.Error("Failed to serialize JavaScript exception, exception:")
	}
	panic(val)
}

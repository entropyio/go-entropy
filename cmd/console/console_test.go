...
import (
	...
	ethconfig "github.com/entropyio/go-entropy/entropy/entropyconfig"
...
func newTester(t *testing.T, confOverride func(*ethconfig.Config)) *tester {
	...
	ethConf := &ethconfig.Config{
		Genesis: blockchain.DeveloperGenesisBlock(15, 11_500_000, common.Address{}),
		Miner: miner.Config{
			EntropyBase: common.HexToAddress(testAddress),
		},

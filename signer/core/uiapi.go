...
func (s *UIServerAPI) ChainId() mathutil.HexOrDecimal64 {
	return (mathutil.HexOrDecimal64)(s.extApi.chainID.Uint64())
}
...
func (s *UIServerAPI) SetChainId(id mathutil.HexOrDecimal64) mathutil.HexOrDecimal64 {

...
type SendTxArgs struct {
	...
	// Issue detail: https://github.com/entropy/go-entropy/issues/15628
	Data  *hexutil.Bytes `json:"data"`
	Input *hexutil.Bytes `json:"input,omitempty"`

	// For non-legacy transactions
	AccessList *model.AccessList `json:"accessList,omitempty"`
...
func (t *Type) isReferenceType() bool {
	...
	// Reference model must have a leading uppercase character
...
type TypedDataDomain struct {
	...
	ChainId           *mathutil.HexOrDecimal256 `json:"chainId"`
...
// Dependencies returns an array of custom model ordered by their hierarchical reference tree
...
func parseInteger(encType string, encValue interface{}) (*big.Int, error) {
	...
	case *mathutil.HexOrDecimal256:
		b = (*big.Int)(v)
	case string:
		var hexIntValue mathutil.HexOrDecimal256
...
func (typedData *TypedData) EncodePrimitiveValue(encType string, encValue interface{}, depth int) ([]byte, error) {
	...
	case "bool":
		...
		if boolValue {
			return mathutil.PaddedBigBytes(common.Big1, 32), nil
		}
		return mathutil.PaddedBigBytes(common.Big0, 32), nil
	case "string":
	...
	if strings.HasPrefix(encType, "int") || strings.HasPrefix(encType, "uint") {
		...
		return mathutil.U256Bytes(b), nil
	}
...
// validate makes sure the model are sound
...
// Validate checks if the model object is conformant to the specs

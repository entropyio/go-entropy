...
import (
	...
	"github.com/entropyio/go-entropy/signer/fourbyte"
...
func (ui *headlessUi) OnApprovedTx(tx entropyapi.SignTransactionResult) {}
...
func TestSignTx(t *testing.T) {
	var (
		list      []common.Address
		res, res2 *entropyapi.SignTransactionResult
		err       error
	)

...
//	rlp.Encode(hw, cc.epochTrie.Hash())
//	rlp.Encode(hw, cc.delegateTrie.Hash())
//	rlp.Encode(hw, cc.candidateTrie.Hash())
//	rlp.Encode(hw, cc.voteTrie.Hash())
//	rlp.Encode(hw, cc.mintCntTrie.Hash())
//	hw.Sum(h[:0])
//	return h
//}
//
...
//	hw := sha3.NewLegacyKeccak256()
//	rlp.Encode(hw, ccp.EpochHash)
//	rlp.Encode(hw, ccp.DelegateHash)
//	rlp.Encode(hw, ccp.CandidateHash)
//	rlp.Encode(hw, ccp.VoteHash)
//	rlp.Encode(hw, ccp.MintCntHash)
//	hw.Sum(h[:0])
//	return h
//}
//

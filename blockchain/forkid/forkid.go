...
func NewFilter(chain *blockchain.BlockChain) func(id ID) error {
	return newFilter(
		chain.Config(),
		chain.Genesis().Hash(),
		func() uint64 {
...
func newFilter(config *config.ChainConfig, genesis common.Hash, headfn func() uint64) func(id ID) error {

...
func verifyNoGaps(t *testing.T, chain *BlockChain, canonical bool, inserted model.Blocks) {
	t.Helper()
...
func verifyCutoff(t *testing.T, chain *BlockChain, canonical bool, inserted model.Blocks, head int) {
	t.Helper()

...
func (h destructBloomHasher) Write([]byte) (n int, err error) { panic("not implemented") }
func (h destructBloomHasher) Sum([]byte) []byte               { panic("not implemented") }
...
func (h accountBloomHasher) Write([]byte) (n int, err error) { panic("not implemented") }
func (h accountBloomHasher) Sum([]byte) []byte               { panic("not implemented") }
...
func (h storageBloomHasher) Write([]byte) (n int, err error) { panic("not implemented") }
func (h storageBloomHasher) Sum([]byte) []byte               { panic("not implemented") }

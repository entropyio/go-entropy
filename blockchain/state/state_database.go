...
// Trie is an Entropy Merkle Patricia trie.
type Trie interface {
	...
	TryUpdateAccount(key []byte, account *model.StateAccount) error
...
func NewDatabase(db database.Database) StateDatabase {
...
// large memory cache.
func NewDatabaseWithConfig(db database.Database, config *trie.Config) StateDatabase {

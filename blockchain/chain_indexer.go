...
type ChainIndexerBackend interface {
	...
	Process(ctx context.Context, header *model.Header) error
...
// queue.
func (c *ChainIndexer) eventLoop(currentHeader *model.Header, events chan ChainHeadEvent, sub event.Subscription) {

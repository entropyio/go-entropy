...
// Account represents an Entropy account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Entropy account address derived from the key

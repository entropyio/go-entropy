...
func mockSign(addr common.Address, tx *model.Transaction) (*model.Transaction, error) { return tx, nil }
...
func (mt *mockTransactor) HeaderByNumber(ctx context.Context, number *big.Int) (*model.Header, error) {
	return &model.Header{BaseFee: mt.baseFee}, nil
}
...
func (mt *mockTransactor) EstimateGas(ctx context.Context, call entropy.CallMsg) (gas uint64, err error) {
	return 0, nil
}

func (mt *mockTransactor) SendTransaction(ctx context.Context, tx *model.Transaction) error {
	return nil
}
...
func (mc *mockCaller) CallContract(ctx context.Context, call entropy.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockPendingCaller) PendingCallContract(ctx context.Context, call entropy.CallMsg) ([]byte, error) {
...
func unpackAndCheck(t *testing.T, bc *bind.BoundContract, expected map[string]interface{}, mockLog model.Log) {
...
func newMockLog(topics []common.Hash, txHash common.Hash) model.Log {
	return model.Log{

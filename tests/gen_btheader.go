...
func (b btHeader) MarshalJSON() ([]byte, error) {
	...
	enc.Nonce = b.Nonce
	enc.Number = (*mathutil.HexOrDecimal256)(b.Number)
	enc.Hash = b.Hash
	...
	enc.Difficulty = (*mathutil.HexOrDecimal256)(b.Difficulty)
	enc.GasLimit = mathutil.HexOrDecimal64(b.GasLimit)
	enc.GasUsed = mathutil.HexOrDecimal64(b.GasUsed)
	enc.Timestamp = mathutil.HexOrDecimal64(b.Timestamp)
	enc.BaseFeePerGas = (*mathutil.HexOrDecimal256)(b.BaseFeePerGas)

...
func NewOracle(backend entropyapi.Backend, params Config) *Oracle {
...
func (gpo *Oracle) SuggestPrice(ctx context.Context) (*big.Int, error) {
	...
	for sent < gpo.checkBlocks && blockNum > 0 {
		go gpo.getBlockPrices(ctx, model.MakeSigner(gpo.backend.ChainConfig(), big.NewInt(int64(blockNum))), blockNum, ch)
		sent++
		exp++
		blockNum--
	}
...
func (gpo *Oracle) getBlockPrices(ctx context.Context, signer model.Signer, blockNum uint64, ch chan getBlockPricesResult) {

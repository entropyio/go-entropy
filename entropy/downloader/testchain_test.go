...
var (
	...
	testGenesis = blockchain.GenesisBlockForTesting(testDB, testAddress, big.NewInt(1000000000000000))
)
...
func newTestChain(length int, genesis *model.Block) *testChain {
	tc := &testChain{
		blocks: []*model.Block{genesis},
	}
...
func (tc *testChain) copy(newlen int) *testChain {
	...
	cpy := &testChain{
		blocks: append([]*model.Block{}, tc.blocks[:newlen]...),
	}
	return cpy
}
...
func newTestBlockchain(blocks []*model.Block) *blockchain.BlockChain {

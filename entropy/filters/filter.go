...
var log = logger.NewLogger("[filters]")
...
func (f *Filter) blockLogs(ctx context.Context, header *model.Header) (logs []*model.Log, err error) {
...
func (f *Filter) checkMatches(ctx context.Context, header *model.Header) (logs []*model.Log, err error) {
...
func (f *Filter) pendingLogs() ([]*model.Log, error) {

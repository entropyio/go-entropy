...
func (es *EventSystem) SubscribeNewHeads(headers chan *model.Header) *Subscription {
	sub := &subscription{
		id:        rpc.NewID(),
...
func (es *EventSystem) lightFilterNewHead(newHeader *model.Header, callBack func(*model.Header, bool)) {
	oldh := es.lastHead
	...
	var oldHeaders, newHeaders []*model.Header
...
func (es *EventSystem) lightFilterLogs(header *model.Header, addresses []common.Address, topics [][]common.Hash, remove bool) []*model.Log {

...
// 4 byte-identifiers of a tx, and implements evm.EVMLogger.
...
func (t *fourByteTracer) CaptureStart(env *evm.EVM, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	...
	t.activePrecompiles = evm.ActivePrecompiles(rules)
...
func (t *fourByteTracer) CaptureState(pc uint64, op evm.OpCode, gas, cost uint64, scope *evm.ScopeContext, rData []byte, depth int, err error) {
}
...
func (t *fourByteTracer) CaptureFault(pc uint64, op evm.OpCode, gas, cost uint64, scope *evm.ScopeContext, depth int, err error) {
}

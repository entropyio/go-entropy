...
func TestStoreCapture(t *testing.T) {
	var (
		...
		env      = evm.NewEVM(evm.BlockContext{}, evm.TxContext{}, &dummyStatedb{}, config.TestChainConfig, evm.Config{Debug: true, Tracer: logger})
		contract = evm.NewContract(&dummyContractRef{}, &dummyContractRef{}, new(big.Int), 100000)
	)
	contract.Code = []byte{byte(evm.PUSH1), 0x1, byte(evm.PUSH1), 0x0, byte(evm.SSTORE)}
...
// logs bloat and confusion. See https://github.com/entropy/go-entropy/issues/24487

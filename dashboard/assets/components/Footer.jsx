...
class Footer extends Component<Props> {
    ...
    render() {
        ...
        return (
            <Grid container className={this.props.classes.footer} direction='row' alignItems='center'
                  style={styles.footer}>
                ...
                <Grid item>
                    ...
                    {general.commit && (
                        <Typography type='caption' color='inherit'>
                            ...
                            <a href={`https://github.com/ethereum/go-ethereum/commit/${general.commit}`} target='_blank'

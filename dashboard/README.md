...
The dashboard is a data visualizer integrated into entropy, intended to collect and visualize useful information of an Entropy node. It consists of two parts:
...
```
$ entropy --dashboard --vmodule=dashboard=5
$ (cd dashboard/assets && yarn dev)
```

To bundle up the final UI into Entropy, run `go generate`:
